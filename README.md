...
For a human-friendly explanation, interactive comparisons, and the **Chinese version** of the license, please visit: **[https://ccbl.cc](https://ccbl.cc)**

## Quick Start

### For Project Maintainers (Using CCBL in Your Project)

1. Copy the plain text from the [`/LICENSE`](./LICENSE) file.
2. Place it in your project's root directory as `LICENSE`.
3. Replace the placeholders: `[year]` and `[copyright holder name]`.
4. (Recommended) Add the [`/AI_POLICY.md`](./AI_POLICY.md) file to your project root.
5. Add a license summary to your `README.md` (see [`/guide.md`](./guide.md)).
...
You must purchase a commercial license from the project's copyright holder. Contact them directly for pricing and terms.
...
The text of the CCBL license and its policies in this repository are dedicated to the public. You may use them freely to license your own software.

## Discussions & Contributions

- **Questions about CCBL?** Check [FAQ.md](./FAQ.md) first.
- **Suggestions or improvements?** Please open a [GitHub Issue](../../issues) (English preferred).
- **For the official website (ccbl.cc) or Chinese translation issues**, use GitHub Issues as well.
...
*CCBL — Contribution-Commercial-Benevolent License*
*Making open source sustainable: contribute, pay, or use freely for personal needs.*
